...
class RobotsController extends StorefrontController
{
    ...
    public function robotsTxt(Context $context, Request $request): Response
    {
        $page = $this->robotsPageLoader->load($request, $context);

        $response = $this->renderStorefront('@Storefront/storefront/page/robots/robots.txt.twig', ['page' => $page]);
